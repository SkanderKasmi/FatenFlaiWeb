	...
	PluginCursorEffect.prototype = {
		...
		build: function() {
			...
			var cursorOuter = document.createElement('DIV');
				cursorOuter.class = 'cursor-outer';

			// Creates the cursor inner node
			var cursorInner = document.createElement('DIV');
				cursorInner.class = 'cursor-inner';
		...
		Nav: {
			...
			focusMenuWithChildren: function() {
				...
				function toggleFocus() {
					...
					while ( -1 === self.class.indexOf( 'header-nav-main' ) ) {
						// On li elements toggle the class .focus.
						if ( 'li' === self.tagName.toLowerCase() ) {
							if ( -1 !== self.class.indexOf( 'accessibility-open' ) ) {
								self.class = self.class.replace( ' accessibility-open', '' );
							} else {
								self.class += ' accessibility-open';
							}
						}
