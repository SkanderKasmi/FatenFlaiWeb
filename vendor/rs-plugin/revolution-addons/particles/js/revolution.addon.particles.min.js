...
b=l.zIndex,c=r+"-tp-particles-",d=l.interactivity.events,d=d.onhover.enable||d.onclick.enable;f.find(".tp-revslider-slidesli").each(function(e){if(d){var h=jQuery(this);h.find(".slidelink").length?(a=!0,"back"!==h.data("slideindex")&&(b=999),this.class+=" rs-particles-slidelink"):this.class+=" rs-particles-interactive"}this.class=this.class+" "+c+(e+1);this.setAttribute("data-particles-index",b)});if(a)jQuery("body").off("click.rsparticles").on("click.rsparticles",".rs-particles-canvas",
