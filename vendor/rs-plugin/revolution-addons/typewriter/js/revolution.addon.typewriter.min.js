...
r,c.appendChild(a));c=w.length;for(a=0;a<c;a++)b.on("revolution.slide."+w[a],this.eventCallback.bind(this))}function x(a,b,c,f){var g=JSON.parse(a.getAttribute("data-typewriter")),k=b.replace(/(_|\|)$/,""),m=a.class,l=g.lines,q=b,p=[],t,e,u,h,d;a.class=m+" hide-typewriter-cursor";for(d in g)g.hasOwnProperty(d)&&(h=g[d],d=d.replace(/_([a-z])/g,z),this[d]="on"===h?1:"off"===h?0:!1===isNaN(h)?parseInt(h,10):h);if(this.blinking&&(r+="#"+a.id+":after {"+'content: "[char]"; animation: tp-typewriter [speed]s steps(2, start) infinite'.replace("[char]",
...
(clearTimeout(this.timer),this.el.innerHTML=this.clean,a&&(this.el.class+=" hide-typewriter-cursor"))}}})();