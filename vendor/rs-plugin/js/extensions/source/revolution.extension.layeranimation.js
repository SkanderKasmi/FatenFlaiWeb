	...
	********************************************/	
	createTimelineStructure : function(opt) {
		...
		function addTimeLineWithLabel(layer,opt,parentobject,slideid) {			
			...
			parentobject[layer.attr('id')].defclasses=c=layer[0].class;
			...
			parentobject[layer.attr('id')].dchildren = c.indexOf("rev_row")>=0 ?  layer[0].getElementsByclass('rev_column_inner') : c.indexOf("rev_column_inner")>=0 ?  layer[0].getElementsByclass('tp-caption') : c.indexOf("rev_group")>=0 ?  layer[0].getElementsByclass('rev_layer_in_group') : "none"; 
